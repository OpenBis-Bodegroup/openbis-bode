...
$PYTHON -m bode_loader.upload_data --dataset_type HPLC --dataset_ab_dir "${HPLC_DIR}" --hierarchy "HPLC reversed phase F310 (former F316)/HPLC data synchronized/**/*.pdf" "HPLC reversed phase F310 (former F316)/HPLC data synchronized/**/*.png" "HPLC reversed phase F316/HPLC Data/**/*.pdf" "HPLC reversed phase F316/HPLC Data/**/*.png" "HPLC reversed phase automated and SEC F318/Exported data/**/*.pdf" "HPLC reversed phase automated and SEC F318/Exported data/**/*.png" "HPLC reversed phase F318/Exported data/**/*.pdf" "HPLC reversed phase F318/Exported data/**/*.png" "HPLC Dionex/**/*.pdf" "HPLC Dionex/**/*.png" "uHPLC reversed phase E316/HPLC Data/Current Users/**/*.pdf" "uHPLC reversed phase E316/HPLC Data/Current Users/**/*.png" --ab_prefix "" --space_structure_path $SPACE_STRUCTURE_PATH
