...
$PYTHON -m bode_loader.upload_data --dataset_type GEL_SCAN --dataset_ab_dir "${GEL_SCAN_DIR}" --hierarchy "*/ChemiDoc Images 2025*/*.jpg" "*/ChemiDoc Images 2025*/*.scn" --ab_prefix ""  --space_structure_path $SPACE_STRUCTURE_PATH #The year needs to be changed according to the current year. Please don't forget :)
